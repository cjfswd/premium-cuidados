...
Premium Cuidados' marketing site for a Rio de Janeiro-based homecare and multidisciplinary medical staffing company. It must communicate two distinct offers clearly: (1) homecare and multidisciplinary assistance for families, (2) SCP contracting of medical/multidisciplinary teams for hospitals. Success = a visitor trusts the brand within seconds and converts via WhatsApp contact.
...
Generic healthcare/insurance-plan clichés: red medical crosses, smiling-doctor stock photography, cold clinical blue, uniform icon-grid cards repeated section after section, tiny uppercase uppercase eyebrows above every section, numbered 01/02/03 scaffolding used decoratively rather than for a real sequence.
...
Standard WCAG AA: body text ≥4.5:1 contrast, respects prefers-reduced-motion, phone number/WhatsApp CTA reachable and legible for older or stressed users (larger tap targets, no reliance on hover-only affordances).
